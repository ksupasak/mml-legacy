...
<?php		
$lines = OrderLine::getLines($orderId); ?>
<style>
</style>
<script>
...
var formatRecommendedDosage = function (o) {
...
var data = <?php echo $lines; ?>;
var cols = [ 
		{key:"display_name", label:"Product Name", sortable: true, formatter: hilighter} ,
		{key:"recommend_dosage", label:"Recommended<br />Dosage (Unit)", formatter: formatRecommendedDosage} ,
