...
<div id="tracking-input" style="border:0px solid">
<?php 
	echo CHtml::beginForm($this->createUrl('order/Tracking'));
?>
	<?php echo CHtml::label('Order ID : ','barcode'); ?>
	<input id="barcode" name="barcode" type="text" />&nbsp;<input id="barcode_submit" name="barcode_bt" type="submit" value="Submit"/>
</div>
<script>
