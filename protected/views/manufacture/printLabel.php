...
<div class="clear"></div>
<span>Doctor : <?php echo $order->getClinician()->full_name;?></span>
...
รับประทานพร้อมอาหารเช้าและเย็น
...
<div class="clear"></div>
<hr/>
ระหว่างรับประทานยา ปัสสาวะจะมีสีและกลิ่น<br/>
เก็บในอุณหภูมิต่ำกว่า 30C<br/> 
ไม่ให้โดนแสงแดดและความชื้น'
